...
/**
 * @author jixing2000
 * @date 2022/8/2 0002 17:06:46
 **/
public class MysqlSaveOrUpdateBatch extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "mysqlSaveOrUpdateBatch", sqlSource, new NoKeyGenerator(), null, null);
    }
